...
sceneslist.push({
    ...
    'layers':[                              /*场景的图层数据*/
        ...
        {"img":"changjing.png","x":2154,"y":877,"attr":{"class":"changjing"}},
        ...
        {"img":"changjingfalse.png","x":2104,"y":1477,"attr":{"class":"false"}},
    ]
})
...
initfunlist.push(function(){
    $('.scene.scene-changfang .strue').pitTouch(function(){
        ...
        setTimeout(function(){
            ...
            $('.scene.scene-changfang .changjing').css('display','block');
        },300)
    })
